          ...
          <div className="container-fluid mb-5">
            ...
            <div className="row justify-content-center">
              <div className="col-sm text-center">
                ...
                <a
                  href="https://github.com/rgreeott/ricochet_webstore_refactor"
                  target="__blank"
                >
              ...
              <div className="col-sm-8 text-justify">
                <div className="row justify-content-center mb-5">
                  <p className="lead">
                    ...
                    Starting, by adding more images of the store and its
                    products, display those images with moving carousels, adding
                    videos explaining what the company does, and creating more
                    action buttons to catch the user's eyes on to certain
                    information.
                  </p>
                </div>
              </div>
