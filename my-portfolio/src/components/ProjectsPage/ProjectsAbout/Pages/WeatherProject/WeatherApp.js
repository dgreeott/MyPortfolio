            ...
            <div className="col-sm-8 text-justify">
              <div className="row justify-content-center mb-5">
                ...
                <p className="lead">
                  ...
                  correct weather forecast for the city you searched. The dates
                  and times will adjust to the correct timezone. To do this, I
                  used Moment.js to convert the date/time from the JSON file.
                  Also, the icons will change according to thing to the status
                  of the description given.
                </p>
                <p className="lead">
                  Lastly, I added another page to display COVID data onto a heat
                  map of the United States. The development of this map was with
                  AmCharts, and the data is coming from an array I made with
                  data from an API. The next phase for the page is to connect
                  the heat map with real-time data from a COVID API. Also,
                  creating a way to search a certain state and get specific data
                  about that state.
                </p>
              </div>
              <div className="row justify-content-center mb-5">
